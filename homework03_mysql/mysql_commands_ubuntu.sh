...
# GTID
STOP REPLICA;
CHANGE REPLICATION SOURCE TO SOURCE_HOST='{your master IP}', SOURCE_USER='repl', SOURCE_PASSWORD='{your_master_password}', SOURCE_AUTO_POSITION = 1, GET_SOURCE_PUBLIC_KEY = 1;
START REPLICA;
